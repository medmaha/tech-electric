...
<div bind:this={container} id="header" class="h-[calc(100vh)] relative w-full overflow-hidden " style="margin-top: -70px;">
    ...
    <div class="absolute w-full h-full bg-black bg-opacity-60" style="z-index: 0;">
    </div>
    <div class="flex h-full w-full bg-black bg-opacity-60 px-2 text-white">
        <div class="max-w-[700px] bg-black bg-opacity-70 shadow-lg rounded-3xl p-2 max-h-[300px] m-auto h-full w-full flex items-center justify-center flex-col gap-2" style="z-index: 1;">
            <div class="w-full text-center">
                <!-- <h2 class="md:text-3xl lg:text-[40px] leading- text-xl font-bold text-green-400">Tec Electrical Training Institute</h2> -->
            
                <h2 class=" font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight text-centerbtext-white">Tec Electrical Training Institute</h2>
            </div>
            <div class="md:text-lg lg:text-xl font-base">
                <p class="tracking-wide text-center px-1 mt-4 mx-auto max-w-[90%] text-green-300" transition:fade>{headline}</p>
            </div>
        </div>
    </div>
</div>