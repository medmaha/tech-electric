    ...
    <div class="pt-10 pb-28 border-t w-full border-slate-200 sm:flex justify-between text-slate-500 dark:border-slate-200/5">
        <div class="mb-6 sm:mb-0 sm:flex">
        <p>Copyright © 2023 Tec Electricals Labs Inc.</p>
    ...
    <div class="flex space-x-10 text-slate-400 dark:text-slate-500">
            <a href="https://github.com/tailwindlabs/tailwindcss" class="hover:text-slate-500 dark:hover:text-slate-400">
